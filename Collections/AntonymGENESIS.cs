...
{
    internal static class AntonymGENESIS
    {
        public static void AntonymGENESISCollection(
           WebDriver webDriver,
           By Nft,
           By NftToBeClicked,
           ...
           double profit)
        {
            ...
            if (MainPageElementsVariables.isVisible)
            {
                ...
                if (MainPageElementsVariables.isSellButtonVisible)
                {
                    ...
                    var collectionType = new Offer.Offer { Type = Offer.OfferType.AntonymGENESIS };
            ...
            {
                if (MainPageElementsCollections.isAntonymGENESISProfitable == true)
                {
                    ...
                    if (MainPageElementsVariables.bestOfferNumber > MainPageElementsCollections.initialValueAntonymGENESIS) // проверяваме дали best offer-а е по голям от моят последен best offer и ако е - продължавам
                    {
                        ...
                        MainPageElementsVariables.maxAvgPrice > MainPageElementsVariables.floorNumber)
                        {
                            ...
                            MainPageElementsCollections.initialValueAntonymGENESIS = MainPageMethods.CalculateMyOfferNumber(fees, profit + 2, MainPageElementsCollections.initialValueAntonymGENESIS);
                            if (MainPageElementsVariables.isMyOfferOnProfit == true)
                            {
                                var offer = new Offer.Offer { Value = MainPageElementsCollections.initialValueAntonymGENESIS, Type = Offer.OfferType.AntonymGENESIS };
                                ...
                                MainPageMethods.SwapWethForEthIfNeeded(webDriver, NftCollection, MainPageElementsCollections.initialValueAntonymGENESIS);
                        ...
                        {
                            MainPageElementsCollections.isAntonymGENESISProfitable = false;
                        }
                    }
                ...
                {
                    MainPageElementsCollections.isAntonymGENESISProfitableCounter++;
                    if (MainPageElementsCollections.isAntonymGENESISProfitableCounter >= 300)
                    {
                        MainPageElementsCollections.isAntonymGENESISProfitable = true;
                        MainPageElementsCollections.isAntonymGENESISProfitableCounter = 0;
                    }
                }
            }
        }
