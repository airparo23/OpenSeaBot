...
{
    internal static class FlowerLolitaCollections
    {
        public static void FlowerLolitaCollectionsCollection(
           WebDriver webDriver,
           By Nft,
           By NftToBeClicked,
           ...
           double profit)
        {
            ...
            if (MainPageElementsVariables.isVisible)
            {
                ...
                if (MainPageElementsVariables.isSellButtonVisible)
                {
                    ...
                    var collectionType = new Offer.Offer { Type = Offer.OfferType.FlowerLolitaCollections };
            ...
            {
                if(MainPageElementsCollections.isFlowerLolitaCollectionsProfitable == true)
                {
                    ...
                    if (MainPageElementsVariables.bestOfferNumber > MainPageElementsCollections.initialValueFlowerLolitaCollections) // проверяваме дали best offer-а е по голям от моят последен best offer и ако е - продължавам
                    {
                        ...
                        MainPageElementsVariables.maxAvgPrice > MainPageElementsVariables.floorNumber)
                        {
                            ...
                            MainPageElementsCollections.initialValueFlowerLolitaCollections = MainPageMethods.CalculateMyOfferNumber(fees, profit + 2, MainPageElementsCollections.initialValueFlowerLolitaCollections);
                            if (MainPageElementsVariables.isMyOfferOnProfit == true)
                            {
                                var offer = new Offer.Offer { Value = MainPageElementsCollections.initialValueFlowerLolitaCollections, Type = Offer.OfferType.FlowerLolitaCollections };
                                ...
                                MainPageMethods.SwapWethForEthIfNeeded(webDriver, NftCollection, MainPageElementsCollections.initialValueFlowerLolitaCollections);
                        ...
                        {
                            MainPageElementsCollections.isFlowerLolitaCollectionsProfitable = false;
                        }
                    }
                
                } else
                {
                    MainPageElementsCollections.isFlowerLolitaCollectionsProfitableCounter++;
                    if(MainPageElementsCollections.isFlowerLolitaCollectionsProfitableCounter >= 300)
                    {
                        MainPageElementsCollections.isFlowerLolitaCollectionsProfitable = true;
                        MainPageElementsCollections.isFlowerLolitaCollectionsProfitableCounter = 0;
                    }
                }
            }
        }
