...
namespace OpenSeaBot.Collections
{
    internal static class AINightbirds
    {
           ...
           double profit)
        {
            ...
            {
                if(MainPageElementsCollections.isAINightbirdsProfitable == true)
                {
                    ...
                    if (MainPageElementsVariables.bestOfferNumber > MainPageElementsCollections.initialValueAINightbirds) // проверяваме дали best offer-а е по голям от моят последен best offer и ако е - продължавам
                    {
                        ...
                        {
                            MainPageElementsCollections.isAINightbirdsProfitable = false;
                        }
                    }
                
                } else
                {
                    MainPageElementsCollections.isAINightbirdsProfitableCounter++;
                    if(MainPageElementsCollections.isAINightbirdsProfitableCounter >= 300)
                    {
                        MainPageElementsCollections.isAINightbirdsProfitable = true;
                        MainPageElementsCollections.isAINightbirdsProfitableCounter = 0;
                    }
                }
            }
        }
