...
{  
    internal static class RetroArcadeCollection
    {
        public static void RetroArcadeCollectionCollection(
           WebDriver webDriver,
           By Nft,
           By NftToBeClicked,
           ...
           double profit)
        {
            ...
            if (MainPageElementsVariables.isVisible)
            {
                ...
                if (MainPageElementsVariables.isSellButtonVisible)
                {
                    ...
                    var collectionType = new Offer.Offer { Type = Offer.OfferType.RetroArcadeCollection };
            ...
            {
                if (MainPageElementsCollections.isRetroArcadeCollectionProfitable == true)
                {
                    ...
                    if (MainPageElementsVariables.bestOfferNumber > MainPageElementsCollections.initialValueRetroArcadeCollection) // проверяваме дали best offer-а е по голям от моят последен best offer и ако е - продължавам
                    {
                        ...
                        MainPageElementsVariables.maxAvgPrice > MainPageElementsVariables.floorNumber)
                        {
                            ...
                            MainPageElementsCollections.initialValueRetroArcadeCollection = MainPageMethods.CalculateMyOfferNumber(fees, profit + 2, MainPageElementsCollections.initialValueRetroArcadeCollection);
                            if (MainPageElementsVariables.isMyOfferOnProfit == true)
                            {
                                var offer = new Offer.Offer { Value = MainPageElementsCollections.initialValueRetroArcadeCollection, Type = Offer.OfferType.RetroArcadeCollection };
                                ...
                                MainPageMethods.SwapWethForEthIfNeeded(webDriver, NftCollection, MainPageElementsCollections.initialValueRetroArcadeCollection);
                        ...
                        {
                            MainPageElementsCollections.isRetroArcadeCollectionProfitable = false;
                        }
                    }
                ...
                else
                {
                    ...
                    {
                        MainPageElementsCollections.isRetroArcadeCollectionProfitable = true;
