...
{
    internal static class JapaneseBornApeSociety
    {
        public static void JapaneseBornApeSocietyCollection(
           WebDriver webDriver,
           By Nft,
           By NftToBeClicked,
           ...
           double profit)
        {
            ...
            if (MainPageElementsVariables.isVisible)
            {
                ...
                if (MainPageElementsVariables.isSellButtonVisible)
                {
                    ...
                    var collectionType = new Offer.Offer { Type = Offer.OfferType.JapaneseBornApeSociety };
            ...
            {
                if(MainPageElementsCollections.isJapaneseBornApeSocietyProfitable == true)
                {
                    ...
                    if (MainPageElementsVariables.bestOfferNumber > MainPageElementsCollections.initialValuejapaneseBornApeSociety) // проверяваме дали best offer-а е по голям от моят последен best offer и ако е - продължавам
                    {
                        ...
                        MainPageElementsVariables.maxAvgPrice > MainPageElementsVariables.floorNumber)
                        {
                            ...
                            MainPageElementsCollections.initialValuejapaneseBornApeSociety = MainPageMethods.CalculateMyOfferNumber(fees, profit + 2, MainPageElementsCollections.initialValuejapaneseBornApeSociety);
                            if (MainPageElementsVariables.isMyOfferOnProfit == true)
                            {
                                var offer = new Offer.Offer { Value = MainPageElementsCollections.initialValuejapaneseBornApeSociety, Type = Offer.OfferType.JapaneseBornApeSociety };
                                ...
                                MainPageMethods.SwapWethForEthIfNeeded(webDriver, NftCollection, MainPageElementsCollections.initialValuejapaneseBornApeSociety);
                        ...
                        {
                            MainPageElementsCollections.isJapaneseBornApeSocietyProfitable = false;
                        }
                    }
                
                } else
                {
                    MainPageElementsCollections.isJapaneseBornApeSocietyProfitableCounter++;
                    if(MainPageElementsCollections.isJapaneseBornApeSocietyProfitableCounter >= 300)
                    {
                        MainPageElementsCollections.isJapaneseBornApeSocietyProfitable = true;
                        MainPageElementsCollections.isJapaneseBornApeSocietyProfitableCounter = 0;
                    }
                }
            }
        }
